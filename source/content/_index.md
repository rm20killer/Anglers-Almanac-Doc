...
---
>[!warning]
>This is very early info about the mod and a lot could change once I have access to the game but will try to keep to this vision as much as possible.

Here is the [[_Roadmap]] for the mod.
...
--- 
# Reason to use Angler's Almanac

## Fishing
Fishing would be gamified making players having to do a small [[Minigames]] and those minigame scaling depending on the reward tier. With a [[Dynamic Loot Pools]] what you hook depends entirely on where you are. The mod merges **Global**, **Zone**, **Regions**, **[[Bait]]** data to build a custom "deck of cards".

## The Almanac book
The heart of the mod is [[The Almanac Book]], your personal guide to the waters of Orbis:
